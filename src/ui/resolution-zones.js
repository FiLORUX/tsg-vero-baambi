...
// Extended profile for NTP 177-800 style (-58 to 0 dBFS / -40 to +18 PPM)
export const RESOLUTION_PROFILE_PPM_EXTENDED = [
  { from: -58, to: -36, multiplier: 1 },  // Lower tail (-40 to -18 PPM)
  { from: -36, to: -24, multiplier: 2 },  // Background (-18 to -6 PPM)
  { from: -24, to: -12, multiplier: 4 },  // Working range (-6 to +6 PPM)
  { from: -12, to: 0,   multiplier: 4 },  // Overload range (+6 to +18 PPM)
];

// ─────────────────────────────────────────────────────────────────────────────
// BBC PPM TYPE IIa PROFILE (−30 → −6 dBFS / PPM 1–7)
// ─────────────────────────────────────────────────────────────────────────────
// Range: 24 dB, TEST at PPM 4 (-18 dBFS), PML at PPM 6 (-10 dBFS)
// IEC 60268-10 Type IIa, 4 dB per division

/**
 * Resolution profile for BBC PPM Type IIa meter
 * Multipliers: x2 (low), x4 (high) only for visual clarity
 * Note: Values are in dBFS
 * @type {ResolutionProfile}
 */
export const RESOLUTION_PROFILE_BBC_PPM = [
  { from: -30, to: -6, multiplier: 4 },  // Uniform resolution across full range (PPM 1-7)
];

// ─────────────────────────────────────────────────────────────────────────────
// SAMPLE PEAK PROFILE (−60 → 0 dBFS)
// ─────────────────────────────────────────────────────────────────────────────
// Range: 60 dB, linear scale, no ballistics
// IEC 60268-18, AES17-2015

/**
 * Resolution profile for Sample Peak meter
 * Multipliers: x2 (background), x4 (near clip)
 * @type {ResolutionProfile}
 */
export const RESOLUTION_PROFILE_SAMPLE_PEAK = [
  { from: -60, to: -12, multiplier: 2 },  // Background range
  { from: -12, to: 0,   multiplier: 4 },  // Critical zone near 0 dBFS
];
