...
export const DEFAULT_STATE = Object.freeze({
  ...
  // Calibration change counter (not persisted)
  // Incremented when profiles are saved/activated/deactivated/deleted
  // UI components watch this to know when to re-read profile data
 ...
 * @property {number} calibrationRevision - Increments on profile changes
 */
